"""
Django settings for lucky_union_40437 project.
...
ROOT_URLCONF = 'lucky_union_40437.urls'
...
WSGI_APPLICATION = 'lucky_union_40437.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_union_40437 API",
    "DESCRIPTION": "API documentation for lucky_union_40437 App",
    "VERSION": "v1",
}
